...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".agent-core/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".agent-core/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.agent-core/agent/sessions)
