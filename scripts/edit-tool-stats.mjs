...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".pi-core/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".pi-core/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.pi-core/agent/sessions)
