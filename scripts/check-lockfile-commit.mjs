...
const allowValue = process.env.PI_CORE_ALLOW_LOCKFILE_CHANGE;
...
if (allowed) {
	console.error("package-lock.json is staged; PI_CORE_ALLOW_LOCKFILE_CHANGE is set, allowing commit.");
	process.exit(0);
}
...
console.error("  PI_CORE_ALLOW_LOCKFILE_CHANGE=1 git commit ...");
process.exit(1);
