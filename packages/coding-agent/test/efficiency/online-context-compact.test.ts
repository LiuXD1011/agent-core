...
} from "../../src/core/efficiency/extensions/online-context-compact/index.ts";
import { restoreOnlineState } from "../../src/core/efficiency/extensions/online-context-compact/state.ts";
import { FakePi, FakeSessionManager, fakeContext } from "./helpers.ts";
import type { CompactOptions, ExtensionContext } from "./host.ts";
