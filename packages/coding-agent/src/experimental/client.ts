...
import { BACKGROUND_CONTEXT, type LaneWatchEvent } from "@liuxuedeng/pi-core-agent";
...
export interface RunClientOptions {
	/** Directory searched when --connect is omitted. Defaults to PI_CORE_SERVER_DIR or ~/.pi-core/server. */
