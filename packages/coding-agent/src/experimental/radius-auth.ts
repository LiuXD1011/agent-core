...
import { DEFAULT_RADIUS_GATEWAY, normalizeRadiusGatewayUrl } from "@liuxuedeng/pi-core-ai/providers/radius-config";
...
export const ENV_RADIUS_GATEWAY = "PI_CORE_RADIUS_GATEWAY";
...
export class RadiusRelayAuthResolver {
	...
	async resolve(options: {
		...
		if (process.env.PI_CORE_OFFLINE !== undefined) {
