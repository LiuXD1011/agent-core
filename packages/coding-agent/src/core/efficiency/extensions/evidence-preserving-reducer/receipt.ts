...
export function receiptText(
	...
	lines.push(
		"authority=Agent retains diagnosis, repair, rerun, and pass/fail adjudication",
		"readback=use read with an explicit line range on source_artifact when exact context is needed",
	);
	return lines.join("\n");
}
