...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@liuxuedeng/pi-core-ai";
 ...
 * Encodes cwd into a safe directory name under ~/.pi-core/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.pi-core/agent/sessions/<encoded-cwd>/).
	 */
