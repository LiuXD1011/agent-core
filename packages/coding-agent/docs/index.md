...
For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @liuxuedeng/pi-core`, `yarn global remove @liuxuedeng/pi-core`, or `bun uninstall -g @liuxuedeng/pi-core`.
