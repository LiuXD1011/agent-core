...
All keyboard shortcuts can be customized via `~/.pi-core/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.pi-core/agent/keybindings.json`:
