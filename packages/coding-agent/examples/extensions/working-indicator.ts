 ...
 * working indicator shown while agent-core is streaming a response.
 *
 * Usage:
 *   agent-core --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore agent-core's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@liuxuedeng/agent-core";
...
function describeMode(mode: WorkingIndicatorMode): string {
	switch (mode) {
		...
		case "default":
			return "agent-core default spinner";
	}
}
