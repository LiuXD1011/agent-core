 ...
 * Demonstrates how extensions can use ctx.shutdown() to exit agent-core cleanly.
 */
...
export default function (pi: ExtensionAPI) {
	// Register a /quit command that cleanly exits agent-core
	pi.registerCommand("quit", {
		description: "Exit agent-core cleanly",
	...
	pi.registerTool({
		...
		description: "Complete a task and exit agent-core",
	...
	pi.registerTool({
		...
		description: "Deploy the application and exit agent-core",
		parameters: Type.Object({
