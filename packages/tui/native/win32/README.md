...
For non-Windows cross-builds, or for custom Windows toolchains, set `PI_CORE_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
PI_CORE_TUI_WIN32_TOOLCHAIN=mingw \
