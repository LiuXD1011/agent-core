...
For non-Windows cross-builds, or for custom Windows toolchains, set `AGENT_CORE_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
AGENT_CORE_TUI_WIN32_TOOLCHAIN=mingw \
