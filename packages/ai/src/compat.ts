 ...
 *
 * Existing apps switch imports from "@liuxuedeng/pi-core-ai" to
 * "@liuxuedeng/pi-core-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@liuxuedeng/pi-core-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@liuxuedeng/pi-core-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@liuxuedeng/pi-core-ai/providers/all" or `Models.getProviders()`. */
