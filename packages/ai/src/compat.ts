 ...
 *
 * Existing apps switch imports from "@liuxuedeng/agent-core-ai" to
 * "@liuxuedeng/agent-core-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@liuxuedeng/agent-core-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@liuxuedeng/agent-core-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@liuxuedeng/agent-core-ai/providers/all" or `Models.getProviders()`. */
