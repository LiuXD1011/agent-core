...
// live under "@liuxuedeng/agent-core-ai/providers/*", API implementations under
// "@liuxuedeng/agent-core-ai/api/*", the old global API under
// "@liuxuedeng/agent-core-ai/compat".
