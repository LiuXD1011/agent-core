# @liuxuedeng/pi-core-client

Transport-neutral client for the experimental Pi service protocol.

```ts
import { Client, type ByteTransportFactory } from "@liuxuedeng/pi-core-client";
...
```ts
import { discoverUnixServers } from "@liuxuedeng/pi-core-client/unix";
