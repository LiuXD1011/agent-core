...
All keyboard shortcuts can be customized via `~/.agent-core/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.agent-core/agent/keybindings.json`:
