...
- [`packages/agent-app/src/session/store.ts`](https://github.com/LiuXD1011/agent-core/blob/main/packages/agent-app/src/session/store.ts) - Session entry types and SessionManager
- [`packages/agent-app/src/session/messages.ts`](https://github.com/LiuXD1011/agent-core/blob/main/packages/agent-app/src/session/messages.ts) - Extended message types (BashExecutionMessage, CustomMessage, etc.)
