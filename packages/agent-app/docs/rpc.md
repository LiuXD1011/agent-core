...
[`AgentSessionEvent`](https://github.com/LiuXD1011/agent-core/blob/main/packages/agent-app/src/app/application.ts)
...
Extended messages from [`packages/agent-app/src/session/messages.ts`](https://github.com/LiuXD1011/agent-core/blob/main/packages/agent-app/src/session/messages.ts#L29):
