...
```json
{
  "$schema": "https://raw.githubusercontent.com/LiuXD1011/agent-core/main/packages/agent-app/src/ui/terminal/theme/theme-schema.json",
  "name": "my-theme",
  "vars": {
    "primary": "#00aaff",
    "secondary": 242
...
- [dark.json](../src/ui/terminal/theme/dark.json)
- [light.json](../src/ui/terminal/theme/light.json)
