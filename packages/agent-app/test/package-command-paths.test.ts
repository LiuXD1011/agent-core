...
import type { ResolvedPaths } from "../src/app/package-manager.ts";
import { InMemorySettingsStorage, SettingsManager } from "../src/app/settings-manager.ts";
import { ProjectTrustStore } from "../src/app/trust-manager.ts";
import { APP_NAME, ENV_AGENT_DIR, PACKAGE_NAME, VERSION } from "../src/config.ts";
import { main } from "../src/main.ts";
import { handlePackageCommand } from "../src/package-manager-cli.ts";
import { ConfigSelectorComponent } from "../src/ui/terminal/components/config-selector.ts";
