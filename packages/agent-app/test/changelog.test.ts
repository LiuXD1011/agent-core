...
describe("normalizeChangelogLinks", () => {
	test("rewrites package-relative changelog links to tag-pinned Agent Core source links", () => {
		...
		expect(normalizeChangelogLinks(markdown, entry)).toBe(
			[
				"[Project Trust](https://github.com/LiuXD1011/agent-core/blob/v0.79.0/packages/agent-app/README.md#project-trust)",
				"[Extensions](https://github.com/LiuXD1011/agent-core/blob/v0.79.0/packages/agent-app/docs/extensions.md#project_trust)",
				"[Examples](https://github.com/LiuXD1011/agent-core/tree/v0.79.0/packages/agent-app/examples/extensions/)",
