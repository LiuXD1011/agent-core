...
import { highlightCode, initTheme } from "../src/ui/terminal/theme/theme.ts";
import {
	highlight,
...
describe("theme syntax highlighting", () => {
	...
	it("keeps cli-highlight default styled scopes mapped to theme styles", () => {
		...
		expect(highlightCode("@decorator", "python")[0]).toBe("\x1b[38;2;164;172;185m@decorator\x1b[39m");
