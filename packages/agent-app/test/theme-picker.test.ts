...
import {
	...
	setRegisteredThemes,
} from "../src/ui/terminal/theme/theme.ts";
...
describe("theme picker", () => {
	...
	beforeEach(() => {
		...
		vi.stubEnv("AGENT_CORE_CODING_AGENT_DIR", agentDir);
	...
	it("uses custom theme content names instead of file names", () => {
		...
		const themePath = join(process.env.AGENT_CORE_CODING_AGENT_DIR!, "themes", "foo.json");
