import { type TUI, visibleWidth } from "@liuxuedeng/agent-core-tui";
...
} from "../src/ui/terminal/components/status-indicator.ts";
import { getEditorTheme, initTheme, theme } from "../src/ui/terminal/theme/theme.ts";
