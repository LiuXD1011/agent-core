...
import { DefaultPackageManager, type ResolvedResource } from "../app/package-manager.ts";
import { SettingsManager } from "../app/settings-manager.ts";
import { APP_NAME, CONFIG_DIR_NAME, ENV_AGENT_DIR, getAgentDir, getSettingsPath, PACKAGE_NAME } from "../config.ts";
import { KeybindingsManager } from "../ui/keybindings.ts";
import { ExtensionInputComponent } from "../ui/terminal/components/extension-input.ts";
import { ExtensionSelectorComponent } from "../ui/terminal/components/extension-selector.ts";
import { FirstTimeSetupComponent, type FirstTimeSetupResult } from "../ui/terminal/components/first-time-setup.ts";
import {
...
const OFFICIAL_PACKAGE_NAME = "@liuxuedeng/agent-core";
const OFFICIAL_APP_NAME = "agent-core";
const OFFICIAL_CONFIG_DIR_NAME = ".agent-core";
 ...
 * - experimental features are enabled (AGENT_CORE_EXPERIMENTAL=1)
