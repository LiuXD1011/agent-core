...
import type { ImageContent, Model, Provider, ProviderHeaders } from "@liuxuedeng/agent-core-ai";
import type { KeyId } from "@liuxuedeng/agent-core-tui";
import type { ResourceDiagnostic } from "../app/diagnostics.ts";
...
import type { KeybindingsConfig } from "../ui/keybindings.ts";
...
const noOpUIContext: ExtensionUIContext = {
	...
	get theme(): Theme {
		throw new Error("Theme requires an attached UI; check ctx.hasUI before rendering");
	},
	getAllThemes: () => [],
	getTheme: () => undefined,
