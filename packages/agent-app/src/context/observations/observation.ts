...
import type { TextContent, ToolResultMessage } from "@liuxuedeng/agent-core-ai";
 ...
 */
const EVIDENCE_REDUCER_RECEIPT_PREFIX = "context_evidence_receipt_v1";
...
/**
 * Archived payloads live under Context's session-derived runtime root.
 *
...
export function createObservation(message: ToolResultMessage, runtimeRoot: string): Observation | undefined {
	...
	if (!runtimeRoot) throw new Error("Persistent Context runtime directory is unavailable");
