...
import { migrateKeybindingsConfig } from "./ui/keybindings.ts";
import { stripBom } from "./utils/text.ts";

const MIGRATION_GUIDE_URL =
	"https://github.com/earendil-works/pi-mono/blob/main/packages/agent-app/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/earendil-works/pi-mono/blob/main/packages/agent-app/docs/extensions.md";
 ...
 *
 * Bug in v0.30.0: Sessions were saved to ~/.pi-core/agent/ instead of
 * ~/.pi-core/agent/sessions/<encoded-cwd>/. This migration moves them
