import type { AuthInfoLink, OAuthDeviceCodeInfo } from "@liuxuedeng/agent-core-ai";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@liuxuedeng/agent-core-tui";
...
export class LoginDialogComponent extends Container implements Focusable {
	...
	private cancel(): void {
		...
		if (this.inputRejecter) {
			this.inputRejecter(new LoginCancelledError());
			this.inputResolver = undefined;
			this.inputRejecter = undefined;
		}
	...
	showAuth(url: string, instructions?: string): void {
		...
		const clickHint = process.platform === "darwin" ? "Cmd+单击打开" : "Ctrl+单击打开";
