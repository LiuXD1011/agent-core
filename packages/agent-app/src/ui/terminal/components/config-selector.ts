...
import type { PathMetadata, ResolvedPaths, ResolvedResource } from "../../../app/package-manager.ts";
import type { PackageSource, SettingsManager } from "../../../app/settings-manager.ts";
