...
import { Container, Text, truncateToWidth } from "@liuxuedeng/agent-core-tui";
import type { ToolDefinition, ToolRenderResultOptions } from "../../../extensions/types.ts";
import type { BashToolDetails } from "../../../tools/bash.ts";
import { DEFAULT_MAX_BYTES, formatSize } from "../../../tools/truncate.ts";
import { keyHint } from "../../terminal/components/keybinding-hints.ts";
import { truncateToVisualLines } from "../../terminal/components/visual-truncate.ts";
import { theme } from "../../terminal/theme/theme.ts";
