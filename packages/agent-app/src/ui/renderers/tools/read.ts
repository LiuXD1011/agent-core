...
import type { ReadToolDetails } from "../../../tools/read.ts";
import { DEFAULT_MAX_BYTES, DEFAULT_MAX_LINES, formatSize } from "../../../tools/truncate.ts";
import { formatPathRelativeToCwdOrAbsolute } from "../../../utils/paths.ts";
import { keyHint, keyText } from "../../terminal/components/keybinding-hints.ts";
import { getLanguageFromPath, highlightCode, type Theme } from "../../terminal/theme/theme.ts";
