 ...
 * - For Node.js (dist/): dist/ui/terminal/theme/
 * - For tsx (src/): src/ui/terminal/theme/
 */
export function getThemesDir(): string {
	...
	return join(packageDir, srcOrDist, "ui", "terminal", "theme");
}

/**
 * Get path to HTML export template directory (shipped with package)
 * - For Bun binary: export-html/ next to executable
 * - For Node.js (dist/): dist/session/export/html/
 * - For tsx (src/): src/session/export/html/
 */
export function getExportTemplateDir(): string {
	...
	const packageDir = getPackageDir();
	const srcOrDist = existsSync(join(packageDir, "src")) ? "src" : "dist";
	return join(packageDir, srcOrDist, "session", "export", "html");
}
 ...
 * - For Node.js (dist/): dist/ui/terminal/assets/
 * - For tsx (src/): src/ui/terminal/assets/
 */
export function getInteractiveAssetsDir(): string {
	...
	const packageDir = getPackageDir();
	const srcOrDist = existsSync(join(packageDir, "src")) ? "src" : "dist";
	return join(packageDir, srcOrDist, "ui", "terminal", "assets");
}
