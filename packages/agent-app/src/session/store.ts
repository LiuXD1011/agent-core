...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@liuxuedeng/agent-core-ai";
 ...
 * Encodes cwd into a safe directory name under ~/.agent-core/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.agent-core/agent/sessions/<encoded-cwd>/).
	 */
