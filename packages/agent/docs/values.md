...
`AssistantMessageFrame`, `AssistantMessageFrameEncoder`, and `reduceAssistantMessageFrames()` come from `@liuxuedeng/pi-core-ai`. Do not define a second frame codec or reducer.
