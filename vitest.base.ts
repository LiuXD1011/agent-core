...
export default defineConfig({
	resolve: {
		alias: [
			{ find: /^@liuxuedeng\/pi-core-chord$/, replacement: workspaceSourcePaths.chordIndex },
			{ find: /^@liuxuedeng\/pi-core-chord\/context$/, replacement: workspaceSourcePaths.chordContext },
			{ find: /^@liuxuedeng\/pi-core-chord\/delta$/, replacement: workspaceSourcePaths.chordDelta },
			{ find: /^@liuxuedeng\/pi-core-chord\/bundler$/, replacement: workspaceSourcePaths.chordBundler },
			{ find: /^@liuxuedeng\/pi-core-chord\/node$/, replacement: workspaceSourcePaths.chordNode },
			{ find: /^@liuxuedeng\/pi-core-telemetry$/, replacement: workspaceSourcePaths.telemetryIndex },
			{ find: /^@liuxuedeng\/pi-core-telemetry\/testing$/, replacement: workspaceSourcePaths.telemetryTesting },
			{ find: /^@liuxuedeng\/pi-core-ai$/, replacement: workspaceSourcePaths.aiIndex },
			{ find: /^@liuxuedeng\/pi-core-ai\/compat$/, replacement: workspaceSourcePaths.aiCompat },
			{ find: /^@liuxuedeng\/pi-core-ai\/oauth$/, replacement: workspaceSourcePaths.aiOAuth },
			{
				find: /^@liuxuedeng\/pi-core-ai\/providers\/(.+)$/,
			...
			{ find: /^@liuxuedeng\/pi-core-agent\/node$/, replacement: workspaceSourcePaths.agentNode },
			{ find: /^@liuxuedeng\/pi-core-protocol$/, replacement: workspaceSourcePaths.protocolIndex },
			{ find: /^@liuxuedeng\/pi-core-client$/, replacement: workspaceSourcePaths.clientIndex },
			{ find: /^@liuxuedeng\/pi-core-client\/unix$/, replacement: workspaceSourcePaths.clientUnix },
			{ find: /^@liuxuedeng\/pi-core-server$/, replacement: workspaceSourcePaths.serverIndex },
			{ find: /^@liuxuedeng\/pi-core-server\/unix$/, replacement: workspaceSourcePaths.serverUnix },
			{ find: /^@liuxuedeng\/pi-core-tui$/, replacement: workspaceSourcePaths.tuiIndex },
		],
	},
});
